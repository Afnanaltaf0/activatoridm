...
::
::   Homepages: https://github.com/Afnanaltaf0/activatoridm
::              https://afnanjamber7.blogspot.com
::
::       Email: ajinin1110@gmail.com
::
::============================================================================
...
choice /C:10 /N
if !errorlevel!==2 rem
if !errorlevel!==1 (start https://github.com/Afnanaltaf0/activatoridm & start %mas%/idm-activation-script & exit /b)
)
)
...
if %_erl%==5 exit /b
if %_erl%==4 start https://github.com/Afnanaltaf0/activatoridm & goto MainMenu
